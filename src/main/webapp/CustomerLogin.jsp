  ...
  <div class="navBox">
       <div class="topBox">
            <span class="name">
                 ...
                 out.println("Welcome Customer: "+cb.getfName()+"&nbsp"+cb.getlName()+"<br>");
		         %>
            </span>
	  ...
	  <div class="leftBox">
            <div class="dashboard">
              <a href="stock2" class="dashbtn">Current Stock</a>
	          <a href="cart" class="dashbtn">Cart Products</a>
	          <a href="profile" class="dashbtn">View Profile</a>
